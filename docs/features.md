...
description: Flat catalog of every Easy Invoice Pro feature — gateways, billing, productivity, tax, URLs, documents, client portal, privacy, branding. With the plan tier matrix.
---
...
Easy Invoice Pro adds ~20 modules to the free core. This page is the catalog — every module, what it does, where it lives in the admin, and a link to the deeper docs.
...
- 💎 [Pro features overview](/third-party-integrations) — guided tour version.
- 💳 [Payment gateways](/payment-settings) — every gateway in detail.
